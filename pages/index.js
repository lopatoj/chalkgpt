    ...
    <main>
      ...
      <div class="w-auto h-auto flex justify-center">
        ...
        <div class="fixed bottom-0 w-1/2">
          <form class="w-full flex p-2 m-5 rounded-md bg-slate-700 shadow-md" onSubmit={handleSubmit}>
            <span class="w-full transition text-3xl bg-slate-700 text-white border-0 py-2 px-2 rounded-l leading-tight focus:outline-none focus:bg-slate-600" id="prompt" type="text" role="textbox" contentEditable="plaintext-only" />
            <button class="bg-slate-700 text-gray-200 p-3 rounded-r text-3xl hover:bg-slate-600 focus:bg-slate-800 transition" type="submit">Submit</button>
          </form>
        </div>
      </div>
    </main>
